...
public:
    ...
    */
    ...
    /** @brief дать сигнал на просыпание поток синхронизации иконок */
    void                ReleaseThreadSyncIcons();
    /** @brief уменьшает счетчик команд, при выполнении которых поток должен работать */
    void                IncreaseCountCommandThreadSyncIcons();
    /** @brief уменьшает счетчик команд, при выполнении которых поток должен работать */
    void                DecreaseCountCommandThreadSyncIcons();
